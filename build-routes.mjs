 ...
 * /mission and /goals/<slug>. Sources use root-absolute paths (/support.js, /assets/...) and the
...
// The page was called Manifesto until 2026-09-15; keep the old address working (query and hash preserved for ?profile= links).
mkdirSync(join(HERE, 'manifesto'), { recursive: true });
writeFileSync(join(HERE, 'manifesto/index.html'), '<!-- GENERATED by build-routes.mjs: /manifesto moved to /mission. -->\n<!DOCTYPE html>\n<html lang="en"><head><meta charset="utf-8"><title>Mission · Bespoke Healthcare</title>\n<link rel="canonical" href="' + ORIGIN + '/mission/">\n<meta http-equiv="refresh" content="0; url=/mission/">\n<script>location.replace("/mission/" + location.search + location.hash);</script>\n</head><body><p>Moved to <a href="/mission/">bespoke.healthcare/mission</a>.</p></body></html>\n');
console.log(`built ${n} routes + /manifesto redirect`);
